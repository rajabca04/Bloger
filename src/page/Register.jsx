...
function Register() {
  return (
    ...
    <div className="w-[80%] flex flex-col space-y-4 md:w-[25%] justify-center items-center border-2 border-black p-8">
        ...
        <button className="w-full font-bold text-white bg-black p-2 rounded-lg hover:bg-green-300   hover:text-black hover:border-2 hover:border-black  ">Register</button>
        <div className=" flex justify-center items-center space-x-3 text-right">
            <p>I have an account?</p>
            <p className="text-gray-500 hover:text-green-400"><Link to="/login">LogIn</Link></p>
        </div>
    </div>
